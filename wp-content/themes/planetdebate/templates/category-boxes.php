<?php global $parent_id;
	...
	<div id="front-page-category-boxes" class="category-boxes container oswald">
			<div class="row">
			  <div class="col-md-3 text-center"><span class="cateogry-box-link-span"><a class="front-page-link" data-category="policy" href="<?php echo get_bloginfo(url); ?>/product-category/2015-2016-surveillance-topic/">Policy</a></span></div>
			  ...
			  <div class="col-md-3 text-center"><span class="cateogry-box-link-span"><a href="<?php echo get_bloginfo(url); ?>/product-category/2014-15-public-forum/">Public Forum</a></span></div>
